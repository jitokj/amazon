        ...
        <div className = "home">
           ...
           <div className="home__row">
               ...
               <Product id="111" title="OPPO A5 2020 (Dazzling White, 4GB RAM, 64GB Storage) with No Cost EMI/Additional Exchange Offers"
                price="11,999" image="https://images-na.ssl-images-amazon.com/images/I/71wPwmxo2NL._SX679_.jpg" rating={4} />
                {/* product */}
                <Product id = "222" title="OnePlus 8 Pro (Glacial Green 8GB RAM+128GB Storage)" price="54,999"
           ...
           <Product id = "222"
            title="Roll over image to zoom in See what Alexa can do Echo Dot (3rd Gen) – Smart speaker with Alexa (Black)"
             price="2,299" image="https://images-na.ssl-images-amazon.com/images/I/61EXU8BuGZL._SL1100_.jpg" rating={4}/>
               {/* product */}
               <Product id="333"
               title= "Acer Nitro 5 Intel Core i5-9th Gen 15.6-inch Display 1920 x 1080 Thin and Light Gaming Laptop (8GB Ram+16GB Optane/1TB HDD/Windows 10 Home/GTX 1650 Graphics/Obsidian Black/2.3 Kgs), AN515-54"
                   price="62,999" image = "https://images-na.ssl-images-amazon.com/images/I/71QXJg8uOCL._SL1500_.jpg" rating={3} />
                {/* product */}
                <Product id="444" title="Sony Bravia 138.8 cm (55 inches) 4K Ultra HD Certified Android LED TV 55X7500H (Black) (2020 Model)"
                price="69,543" image="https://images-na.ssl-images-amazon.com/images/I/91QD0vRZdVL._SX679_.jpg" rating={5} />
                {/* product */}
